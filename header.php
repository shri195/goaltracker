            ...
            <div class="sidebar-header">
                <?php 
                    if(!empty($result[0]['site_logo'])){?>
                        <a href="dashboard.php" class="navbar-brand p-0 text-dark"><img src="images/site-logo/<?php echo $result[0]['site_logo']; ?>"></a>
                <?php }else{ ?>
                        <h2><a href="dashboard.php" class="navbar-brand p-0 text-dark"><?php echo $result[0]['site_name']; ?></a></h2>
                <?php } ?>
            </div>
